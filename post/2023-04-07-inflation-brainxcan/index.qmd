...
$h^2_\text{IDP}$ is the proportion of variance in the predicted IDP explained by the genetic component of the IDP. In other words, 1 - $h^2_\text{IDP}$ is a measure of the uncertainty in our prediction of IDP.
...
$\text{Var}(Z_\text{bxcan}) = 1 + N  \cdot h_Y^2 \cdot h^2_\text{IDP} \cdot \frac{\text{tr}(R'R)}{\text{tr}^2(R)}$
:::
