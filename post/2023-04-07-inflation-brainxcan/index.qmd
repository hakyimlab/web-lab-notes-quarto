...
```{r simulate Y}
## betamat msnp x 1 
betamat = matrix(rnorm(msnp),msnp, nsim)
epsimat = matrix(rnorm(nsam),nsam, nsim)
...
%%HERE continue here: TODO: make sure fast_predixcan is running nsim times: look at dimensions of matrices...
